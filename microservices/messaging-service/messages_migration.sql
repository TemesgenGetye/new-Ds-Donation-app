-- Migration script for messaging-service database
-- Run this in your new Supabase project SQL editor

-- Create messages table
-- Note: campaign_id and donation_id are stored as UUIDs but don't have foreign keys
-- since campaigns and donations are in separate databases
...
COMMENT ON COLUMN messages.campaign_id IS 'Optional: Link message to a campaign';
COMMENT ON COLUMN messages.donation_id IS 'Optional: Link message to a donation';
